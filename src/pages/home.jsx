...
function PracticasApp() {
  return (
    <div>
      ...
      <div style={{ marginLeft: '280px',paddingLeft: '300px', paddingBottom: '0', padding: '20px', backgroundColor: '#1a1a1a', minHeight: '10vh', width:'900px' }}>
      ...
      <div style={{ marginLeft: '300px', width: '880px', marginTop: '20px', fontSize: '18px', border: '2px solid #ff6600', borderRadius: '8px', padding: '10px' }}>
        <h2>¿Tienes dudas?</h2>
